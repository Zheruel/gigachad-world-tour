...
Replace Pappu and the old Mirchi encounter with one food-vendor boss: blockable ladle combinations, reflectable utensils, rare committed cart rush, breakable cart protection and an interruptible pressure valve. Baiting a rush into his cooking station breaks guard. Cart destruction permanently removes his rush. Starting health is 400; target 75–105 seconds with dedicated intro, reactions and defeat performance. Input-only automated runs establish faster lower bounds; their completion time is not a human pacing approval.
