...
The runtime code and root documents describe the current build. Files in this directory
are longer design records and future proposals; they are not all implemented.
...
production, read `../ANIMATION_PIPELINE.md`.

When implementation changes, update the root source of truth first. Preserve historical
design rationale here only when it remains useful, and label proposals clearly.
