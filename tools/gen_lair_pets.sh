...
echo "=== the tank ==="
SHARK="a huge powerful great white shark seen in exact side profile facing right, slate grey above and cream white below, a heavy scarred snout, a mouth open just enough to show rows of white teeth, tiny wraparound black sunglasses, and a fat lit Cuban cigar with a red and gold band clamped in the corner of its jaws with a glowing ember at the tip"
...
# The tank floor: one shark needs somewhere to live, and a shoal of piranhas turned out
# to be busy rather than alive. Drawn behind him, clipped to the glass. His lounge mirrors
# CHAD's - the armchair and the whisky are the joke, and the neon lights the tank from in.
$G $O/tankscape.png landscape "The floor of a huge aquarium seen from the side, drawn as ONE WIDE HORIZONTAL STRIP filling the width of the image and only the lower third of it tall, with flat green above it. It is a shark's private lounge: a tiny sunken leather armchair and a small round table with a bottle and a glass on it, a miniature neon sign glowing magenta on a broken brick wall behind them, a burst crate of gold bars, a rusted anchor, a stone skull half buried in pale sand, and tall dark green kelp at both ends. Everything sits on rippled pale sand. Rich, dramatic and detailed, lit from above. No fish, no shark, no divers, no people. $S" &
