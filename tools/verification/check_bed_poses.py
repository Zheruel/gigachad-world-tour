...
Every pose in assets/sources/production/lair/bed/ is generated against p0 with an instruction not to
...
base band, how much of the FURNITURE still differs from p0?
  ...
  ./.venv/bin/python tools/verification/check_bed_poses.py [--verbose]
...
SRC = "assets/sources/production/lair/bed/"
