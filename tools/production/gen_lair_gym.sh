...
$G assets/sources/production/fg/fg_weights.png landscape "Three big black cast iron olympic weight plates lying and leaning against each other on the floor seen from the side, a white chalk bowl and a rolled white gym towel beside them, heavy and worn with chipped paint, $S" &
wait

echo "=== gym done ==="
echo "  ./.venv/bin/python tools/production/process_props.py gym_curl gym_bench gym_plates gym_kettles gloves"
echo "  ./.venv/bin/python tools/production/process_fg.py fg_weights"
