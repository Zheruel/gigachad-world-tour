...
def main():
    sheet = Image.open(ROOT / "assets/sources/production/sheet/delhi_cloth_loops_v4.png")
    for i in range(8):
    ...
    for i in range(1, 5):
        src = Image.open(ROOT / f"assets/sources/production/ambience_v4/delhi_fan_{i}.png")
        save_scaled(src, ROOT / f"assets/ambience/delhi_fan_{i}.png", 38, 42)

    for i in range(1, 7):
        src = Image.open(ROOT / f"assets/sources/production/fx_v4/ragnarok_impact_{i}.png")
