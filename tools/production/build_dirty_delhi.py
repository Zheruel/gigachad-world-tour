...
The route contains six areas across 26 screens, with one registered wall and floor.
...
SOURCE = ROOT / "assets/sources/production/stages/dirty_delhi/environment"
...
def build() -> None:
    ...
    # Save the shared palette to keep the long stage plates compact.
