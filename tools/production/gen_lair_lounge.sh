...
P0=assets/sources/production/lair/lounge_chad.png
$G assets/sources/production/lair/smoke_1.png landscape "$MAN. He is lifting the cigar from the arm of the sofa up towards his face, his forearm about half way there, still looking straight ahead. $SAME $S" "$P0" &
$G assets/sources/production/lair/smoke_2.png landscape "$MAN. The cigar is at his lips and he is drawing on it, his chin dipped slightly and the ember at the tip glowing bright orange. $SAME $S" "$P0" &
wait
...
$G assets/sources/production/lair/smoke_3.png landscape "$MAN. He has taken the cigar away from his mouth and tipped his head back, mouth open, blowing a long slow plume of smoke straight upward. His hand holds the cigar out to the side at chest height. $SAME $S" "$P0" &
wait
