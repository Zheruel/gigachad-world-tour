...
O=assets/sources/production/title
mkdir -p $O
...
echo "  tools/production/build_title.sh $O/title_b.png 0.20"
echo "  and the wordmark: key $O/logo.png, trim, scale to 520 wide, quantize 32 -> assets/ui/logo.png"
ls -la $O
