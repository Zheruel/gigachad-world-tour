...
O=assets/sources/production/stages/dirty_delhi/cast_legacy
A=assets/sources/production
...
wait
echo "=== hurt2 done ==="; ls assets/sources/production/stages/dirty_delhi/cast_legacy/*_hurt2.png | wc -l
