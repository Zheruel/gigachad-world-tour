...
$G assets/sources/production/bg_gymfloor2.png landscape "Polished dark wooden gym floor planks with a warm glossy sheen, scuffs and worn patches, faint painted court line, warm amber lamp reflections. $F" &
wait
echo FLOORS-DONE
