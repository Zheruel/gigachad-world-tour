...
#
# Panels are stitched by tools/production/build_dirty_delhi.py. The floor textures are NOT floors -
...
#
# Usage: tools/production/gen_d1_plates.sh [derisk|market|river|floors|all]
set -uo pipefail
cd "$(dirname "$0")/../.."
G=tools/production/gen_codex.sh
O=assets/sources/production/stages/dirty_delhi/environment
mkdir -p $O
