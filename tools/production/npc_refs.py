...
which is the difference between a figure that belongs and one that is pasted on.
  ...
  npc_refs.py            -> assets/sources/production/npcref/<kind>_<x>.png
"""
import os
import re
...
OUT = "assets/sources/production/npcref/"
...
def main():
    ...
    wall = Image.open("assets/stages/dirty_delhi/wall.png").convert("RGB")
    floor = Image.open("assets/stages/dirty_delhi/floor.png").convert("RGB")
