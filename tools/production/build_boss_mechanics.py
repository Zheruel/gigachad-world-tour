...
def main():
    ...
    # Extra transparent width retains the full extended cane without moving its
    # original body pivot, floor contact, or rendered scale.
    specs=[('nr_conductor','shield',(320,240),233,.44,[(0,0,512,510,310),(512,0,1024,510,760),(1024,0,1536,510,1240)]),('nr_vikram_roof','sweep',(320,224),217,.40,[(0,510,490,1024,280),(495,510,1060,1024,720),(1070,510,1536,1024,1240)])]
