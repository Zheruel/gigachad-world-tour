...
Example:
  ./.venv/bin/python tools/production/video_to_sprite.py tiger-prowl.mp4 \
    assets/qa/video/tiger-prowl --frames 8 --target-height 116 --anchor torso
"""
...
from build_lair_animation import rescale_set, torso_place, trim
