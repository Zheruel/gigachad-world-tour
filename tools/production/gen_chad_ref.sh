...
$G assets/sources/production/ref_chad_a.png portrait "$CHAD, $STYLE" &
$G assets/sources/production/ref_chad_b.png portrait "$CHAD, one hand adjusting his sunglasses, smirking, $STYLE" &
$G assets/sources/production/ref_chad_c.png portrait "$CHAD, arms crossed over his chest, chin raised, unimpressed expression, $STYLE" &
wait
echo "--- refs done ---"
ls -la assets/sources/production/ref_chad_*.png
