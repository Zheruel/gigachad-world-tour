...
the same spot as tools/production/build_motorcycle.py puts it. Reads the raw green-screen
generation from assets/sources/motorcycle/bike_only.png, writes
assets/story/motorcycle/bike.png.
"""
...
from build_motorcycle import CANVAS, OUT, WHEEL_BOTTOM, WHEEL_X, front_template, front_wheel, load_frames, rear_template, register_rear

RAW = Path(__file__).resolve().parents[2] / "assets/sources/motorcycle/bike_only.png"
